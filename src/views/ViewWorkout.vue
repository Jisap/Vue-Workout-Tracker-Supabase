    ...
    <div v-if="dataLoaded">
      ...
      <div class="mt-10 p-8 rounded-md flex flex-col item-center bg-light-grey shadow-md">
        ...
        <div v-else class="flex flex-col gap-y-4 w-full">
          ...
          <img 
            @click="deleteExercise(item.id)" 
            v-if="edit" class="absolute h-4 w-auto -left-5 cursor-pointer"
            src="@/assets/images/trash-light-green.png" 
            alt="" 
          /> 
          </div>
...
export default {
  ...
  setup() {
    ...
    return { statusMsg, data, dataLoaded, errorMsg, edit, editMode, user, addExercise, deleteWorkout, deleteExercise, update };
  },
};
</script>
